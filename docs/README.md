# Witness Circles documentation

Choose the shortest path that matches your role.
...
- [Creator guide](creator-guide.md): contexts, events, renderers, releases, moderation, and ethical growth

## Developers

- [Architecture](developers/architecture.md): layers, trust boundaries, state, and reorganization behavior
- [SDK and CLI](developers/sdk-cli.md): installation and exported interfaces
- [Integration guide](developers/integrations.md): wallets, indexers, explorers, data platforms, and applications
- [Test vectors](developers/test-vectors.md): differential validation and fixture policy

## Operators

- [Deployment](operators/deployment.md): clean builds, static site, Core integration expectations, backups, and rollback
